...
export const StrategyCard: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", padding: "60px 100px" }}>
      <div style={{ fontSize: 46, fontWeight: 700, color: theme.gold, fontFamily: theme.font, textAlign: "center", marginBottom: 36, opacity: titleOpacity, transform: `translateY(${interpolate(titleP, [0, 1], [-16, 0])}px)` }}>
        {data.title}
      </div>
      ...
      <div style={{ flex: 1, display: "flex", gap: 24 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 32, fontWeight: 800, color: theme.green, fontFamily: theme.font, display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {doItems.map((item, i) => {
            ...
            return (
              <div key={i} style={{ fontSize: 34, color: theme.white, fontFamily: theme.font, paddingLeft: 20, borderLeft: `4px solid ${theme.green}40`, opacity: itemOpacity, lineHeight: 1.4 }}>
                {item}
              </div>
            );
          })}
        ...
        <div style={{
          ...
          <div style={{ fontSize: 32, fontWeight: 800, color: theme.red, fontFamily: theme.font, display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {dontItems.map((item, i) => {
            ...
            return (
              <div key={i} style={{ fontSize: 34, color: theme.white, fontFamily: theme.font, paddingLeft: 20, borderLeft: `4px solid ${theme.red}40`, opacity: itemOpacity, lineHeight: 1.4 }}>
                {item}
              </div>
            );
          })}
      ...
      {conclusion && (
        <div style={{ fontSize: 30, color: theme.tiffany, fontFamily: theme.font, textAlign: "center", marginTop: 20, fontWeight: 600, opacity: concOpacity }}>
          💡 {conclusion}
        </div>
      )}
    </div>
