...
export const Comparison: React.FC<Props> = ({ data, durationFrames }) => {
  ...
  const renderCard = (
    ...
    return (
      <div style={{
        flex: 1,
        background: `linear-gradient(160deg, ${color}0d 0%, rgba(0,0,0,0) 100%)`,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: 2, height: 60, background: "rgba(129,216,208,0.15)" }} />
        <div style={{
          fontSize: 48, fontWeight: 900, color: theme.grayLight,
          fontFamily: theme.font,
          textShadow: `0 0 ${20 + vsPulse * 16}px rgba(255,255,255,${0.08 + vsPulse * 0.12})`,
        }}>
          VS
        </div>
        <div style={{ width: 2, height: 60, background: "rgba(129,216,208,0.15)" }} />
