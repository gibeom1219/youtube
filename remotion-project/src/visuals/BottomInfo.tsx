...
export const BottomInfo: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", position: "relative" }}>
      {/* 콘텐츠 (하단) — 오버레이는 FinanceVideo에서 SceneTransition 바깥에 렌더링 */}
      <div style={{
        position: "absolute", bottom: 240, left: 180, right: 180,
        ...
        <div style={{
          ...
          background: "#111", marginBottom: 24,
